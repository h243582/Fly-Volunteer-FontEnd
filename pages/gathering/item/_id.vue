        ...
        <div class="simple-text">
            ...
            <div class="right-intro">
                ...
                <div class="content-item">
                    ...
                    <div class="social-share" data-sites="weibo,qq,qzone,wechat,facebook,twitter,google" data-url="itheima.com" data-title="博客社交"></div>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    head: {
        script: [
            ...
            { src: 'https://cdn.bootcss.com/qrcode-generator/1.3.1/qrcode.js' } //微信分享所需样式
        ],
        link: [
